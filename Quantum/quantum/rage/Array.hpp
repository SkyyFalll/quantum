    ...
    public:
        ...
        void append(atArray<T> array_value)
        {
            ...
            if ((value_array_size + m_count) > std::numeric_limits<uint16_t>::max())
                printf("RAGE atArray::append was given too large of an atArray to append\n");
        ...
        void append(std::vector<T> value_array)
        {
            ...
            if ((value_array_size + m_count) > std::numeric_limits<uint16_t>::max())
                printf("RAGE atArray::append was given too large of a vector to append\n");
        ...
        void append(const std::initializer_list<T> value_array)
        {
            ...
            if ((value_array_size + m_count) > std::numeric_limits<uint16_t>::max())
                printf("RAGE atArray::append was given too large of a list to append\n");
